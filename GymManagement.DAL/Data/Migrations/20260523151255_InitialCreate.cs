        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GymUser_Email", "Email LIKE '_%@%._%'");
                    table.CheckConstraint("CK_GymUser_Phone", "PhoneNumber LIKE '010[0-9]%' or PhoneNumber LIKE '011[0-9]%' or PhoneNumber LIKE '012[0-9]%' or PhoneNumber LIKE '015[0-9]%' AND LEN(PhoneNumber) >= 10 AND LEN(PhoneNumber) <= 15");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GymUser_Email1", "Email LIKE '_%@%._%'");
                    table.CheckConstraint("CK_GymUser_Phone1", "PhoneNumber LIKE '010[0-9]%' or PhoneNumber LIKE '011[0-9]%' or PhoneNumber LIKE '012[0-9]%' or PhoneNumber LIKE '015[0-9]%' AND LEN(PhoneNumber) >= 10 AND LEN(PhoneNumber) <= 15");
                });
